...
class TestTPUJaxRunner:
    ...
    def test_prepare_inputs_hybrid_kvcache(self, mock_sampling_metadata):
        ...
        assert len(output) == 9
        input_ids, positions, attention_metadata, sampling_metadata, pooling_metadata, logits_indices, spec_decode_metadata, logits_indices_selector, padded_num_reqs = output
